...
public class GUI {
	...
	BattleRifle BattleRifle2 = new BattleRifle(2,6,"Equipo2");
	   	...
	   	public void BOTONES () {
	   		...
	   		JButton caminarLegion1=new JButton("Escudo Torreta");//creating instance of JButton  
	   			...
	   			caminarLegion1.addActionListener(new ActionListener() {
	   				...
	   				public void actionPerformed(ActionEvent e) {
	   					// TODO Auto-generated method stub
	   					legion1.escudoDeTorreta();
	   					
	   					System.out.println("Escudo Torreta LEGION1");
	   					popUpEstado();
	   				}
	   			});
	   		...
	   		JButton tomarArmaLegion1=new JButton("TOMAR ARMA");//creating instance of JButton  
	   			...
	   			tomarArmaLegion1.addActionListener(new ActionListener() {
	   				...
	   				public void actionPerformed(ActionEvent e) {
	   					// TODO Auto-generated method stub
////////////	   					legion1.tomarArma(blancoEquipo1.getText());
	   		...
	   		JButton caminarLegion2=new JButton("Escudo Torreta");//creating instance of JButton  
	   			...
	   			caminarLegion2.addActionListener(new ActionListener() {
	   				...
	   				public void actionPerformed(ActionEvent e) {
	   					// TODO Auto-generated method stub
	   					legion2.escudoDeTorreta();
	   					System.out.println("Escudo torreta LEGION2");
	   					popUpEstado();
	   		...
	   		JButton apunalarAssasin1 = new JButton("Apunalar");
	   			...
	   			apunalarAssasin1.addActionListener(new ActionListener() {
	   				...
	   				public void actionPerformed(ActionEvent e) {
	   					// TODO Auto-generated method stub
//////////	   					Assasin1.apunalar(blancoEquipo1.getText());
